...
from odoo_bridge.app_ui.config import build_app_ui_config
...
def main() -> int:
    ...
    parser.add_argument(
        "--variant",
        choices=("classic", "unocss"),
        default="classic",
        help="Asset variant to publish",
    )
    ...
    manager = AppUiThemeManager(
        client,
        project_root=Path(args.project_root),
        config=build_app_ui_config(args.variant),
    )
